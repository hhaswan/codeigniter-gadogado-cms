...
<link rel="stylesheet" href="{{base_url()}}adminlte/components/morris.js/morris.css">
<link rel="stylesheet" href="{{base_url()}}adminlte/components/jvectormap/jquery-jvectormap.css">
