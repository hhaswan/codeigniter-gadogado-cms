...
<meta name="theme-color" content="{{app()->color_back}}" />
...
<meta name="description" content="{{app()->name}} oleh {{app()->company}}">
...
<link rel="stylesheet" href="{{app()->template_back}}components/bootstrap/dist/css/bootstrap.css">
...
<link rel="stylesheet" href="{{app()->template_back}}css/AdminLTERed.min.css">
<link rel="stylesheet" href="{{app()->template_back}}components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
<link rel="stylesheet" href="{{app()->template_back}}components/bootstrap-daterangepicker/daterangepicker.css">
<link rel="stylesheet" href="{{app()->template_back}}plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<link rel="stylesheet" href="{{app()->template_back}}plugins/bootstrap-select/bootstrap-select.min.css">
<link rel="stylesheet" href="{{app()->template_back}}components/datatables.net-bs/css/dataTables.bootstrap.min.css">
